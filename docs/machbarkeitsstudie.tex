...
\begin{minipage}{5in}
  \centering
  \raisebox{-0.5\height}{\includegraphics[height=3.25in]{ec_tests}}
\end{minipage}
...
\subsubsection{Fazit}
Da Redis bei den Kriterien, wie z.B. der Performance und den einfachen Zugriff auf Daten durch
seine Kompaktheit, besser als MongoDB abschneidet, haben wir uns entschieden Redis als DBMS zur
Datenverwaltung zu verwenden.

\subsection{Gesamtfazit}
Am Anfang wurde entschieden, dass ein NoSQl DBMS verwendet wird. Dann wurden die Systeme
MongoDB und Redis evaluiert und aufgrund der angef\"uhrten Kriterien wird das DBMS Redis zur
