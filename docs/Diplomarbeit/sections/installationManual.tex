...
\begin{figure}[htb!]
	\begin{minipage}{.5\textwidth}
		1.Start the setup
		\centering\includegraphics[width=0.9\textwidth]{images/install1}
	\end{minipage}
	\begin{minipage}{.5\textwidth}
		2.Select the install location
		\centering\includegraphics[width=0.9\textwidth]{images/install2}
	\end{minipage}
	\begin{minipage}{.5\textwidth}
		3.Add application directory to system path
		\centering\includegraphics[width=0.9\textwidth]{images/install3}
	\end{minipage}
	\begin{minipage}{.5\textwidth}
		4.Finish the setup
		\centering\includegraphics[width=0.9\textwidth]{images/install4}
	\end{minipage}
