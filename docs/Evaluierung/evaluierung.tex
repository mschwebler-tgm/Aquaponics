...
28.11.2016                           & 1.1                                  & \begin{tabular}[c]{@{}l@{}}Matthias Schwebler,\\ Ramin Bahadoorifar,\\ Konrad Kelc,\\ Samuel Schober\end{tabular}                                  & \"Uberarbeitung                       &  \\ \cline{1-4}
\end{tabular}
\end{table}
\newpage
\section{Einf\"uhrung}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Single Board Computer - User Story 1817}
...
%             Sensoren              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Sensoren - User Story 1975}
...
\begin{minipage}{5in}
  \centering
  \raisebox{-0.5\height}{\includegraphics[height=1.0in]{temp_sensor_connection_detail}}
  \raisebox{-0.5\height}{\includegraphics[height=2.3in]{temp_sensor_connection}}
\end{minipage}
...
\begin{minipage}{5in}
  \centering
  \raisebox{-0.5\height}{\includegraphics[height=2.0in]{ec_sensor_connection}}
\end{minipage}
\newpage
...
\begin{minipage}{5in}
  \centering
  \raisebox{-0.5\height}{\includegraphics[height=2.0in]{ph_sensor_connection}}
\end{minipage}
...
%              Aktoren              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Aktoren - User Story 1979}
...
\begin{minipage}{5in}
  \centering
  \raisebox{-0.5\height}{\includegraphics[height=2.3in]{water_pump_connection}}
\end{minipage}
...
\begin{minipage}{5in}
  \centering
  \raisebox{-0.5\height}{\includegraphics[height=2.3in]{mineral_pump_connection}}
\end{minipage} 
...
\begin{minipage}{5in}
  \centering
  \raisebox{-0.5\height}{\includegraphics[height=2.2in]{led_connection}}
\end{minipage} 
Leistung: 5.5 watts \\
Beleuchtung: 72 LEDs \\
